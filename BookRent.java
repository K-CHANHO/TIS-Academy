...
public class BookRent extends JPanel{
	...
	public BookRent() { // 생성자
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hkd", "hong");
	    ...
	    String[] dept={"전체","컴퓨터시스템","멀티미디어","컴퓨터공학", "아무개학과"};
	    ...
	    cb_dept.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(cb.getSelectedIndex()==0) {
					...
					//컴퓨터공학
					query+=" and s.dept='아무개학과' order by br.no";
				}
